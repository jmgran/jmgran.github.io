...
In 2024 I held an online ISCB course in biostatistics together with Ruth Keogh on [causal inference for time-to-event outcomes with practical applications in R](iscbcourse){target="_blank"}. In 2025 we we will hold a version of the same course as a pre-conference course at the [Nordic-Baltic Biometric Conference](https://www.nbbc2025.com){target="_blank"} in Oslo.
